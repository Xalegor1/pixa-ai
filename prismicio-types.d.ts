...
/**
 * Item in *Bento → Default → Primary → Repetable*
 */
export interface BentoSliceDefaultPrimaryRepetableItem {
  /**
   * Title field in *Bento → Default → Primary → Repetable*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.repetable[].title
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  title: prismic.RichTextField;

  /**
   * Body field in *Bento → Default → Primary → Repetable*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.repetable[].body
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  body: prismic.RichTextField;

  /**
   * Image field in *Bento → Default → Primary → Repetable*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.repetable[].image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  image: prismic.ImageField<never>;

  /**
   * Wide field in *Bento → Default → Primary → Repetable*
   *
   * - **Field Type**: Boolean
   * - **Placeholder**: *None*
   * - **Default Value**: false
   * - **API ID Path**: bento.default.primary.repetable[].wide
   * - **Documentation**: https://prismic.io/docs/field#boolean
   */
...
export interface BentoSliceDefaultPrimary {
  ...
  /**
   * Repetable field in *Bento → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: bento.default.primary.repetable[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  repetable: prismic.GroupField<
    Simplify<BentoSliceDefaultPrimaryRepetableItem>
  >;
}
...
/**
 * Item in *CaseStudies → caseStudy → Primary → Case Studies*
 */
export interface CaseStudiesSliceDefaultPrimaryCaseStudiesItem {
  /**
   * Case Study field in *CaseStudies → caseStudy → Primary → Case Studies*
   *
...
/**
 * Primary content in *CaseStudies → caseStudy → Primary*
 */
export interface CaseStudiesSliceDefaultPrimary {
  /**
   * Heading field in *CaseStudies → caseStudy → Primary*
   *
   * - **Field Type**: Title
   * - **Placeholder**: *None*
  ...
  /**
   * Body field in *CaseStudies → caseStudy → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
  ...
  /**
   * Case Studies field in *CaseStudies → caseStudy → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
...
/**
 * caseStudy variation for CaseStudies Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      AllDocumentTypes,
      BentoSlice,
      BentoSliceDefaultPrimaryRepetableItem,
